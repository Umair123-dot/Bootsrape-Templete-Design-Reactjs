        ...
        <div className="row pt-3">
            ...
            <div className="col-12 col-md-6 pt-5">
                <div className="course-detail-content">
                    ...
                    <p className="coursed--para">Take courses from the world’s best instructors and
                        universities.
                        Courses include recorded auto-graded
                        and peer-reviewed assignments, video lectures, and community discussion forums. When
                        you complete a course,
                        you’ll be eligible to receive a shareable electronic Course Certificate for a small
                        fee.</p>
                    <p className="detail-feedb-small">The courses that Kimmie has taken</p>
                    ...
                    <div className="coursed-feedb-image d-flex">
                        ...
                        <div className="feedb-image-con">
                            ...
                            <p className="course-feedb-image-p">The Museum of Modern Art</p>
                        </div>
                    </div>
                </div>
            </div>
