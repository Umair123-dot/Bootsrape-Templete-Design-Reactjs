            ...
            <div className="row flex-column flex-md-row flex-lg-row py-4">
              <div className="col-12 col-md-12 col-lg-7 col-xl-7">
                <div className="image-text d-flex justify-content-center align-content-center">
                  ...
                  <p className="text-up pt-5 px-4 px-lg-3  text-center">
                    Upcoming Our{" "}
                    <span className="change-text-c">Basic in Python</span>
                    Course!
                  </p>
                </div>
              </div>
              <div className="col-12 col-md-12 col-lg-5 col-xl-5">
                <div className="lanch-time d-flex justify-content-center align-items-center">
                  <div className="time">
                    <p className="t-hours">
                      11<span className="time-dot">:</span>
                    </p>
                    <span className="t-minutes">Days</span>
                  </div>
                  <div className="time">
                    <p className="t-hours">
                      02<span className="time-dot">:</span>
                    </p>
                  ...
                  <div className="time">
                    <p className="t-hours">
                      45<span className="time-dot">:</span>
                    </p>
      ...
      <div className="top-feature-wrappers">
        <div className="container">
          <div className="row mt-5 mb-3 d-flex align-items-center justify-content-center">
            <p className="display-5 text-center top-heading">
